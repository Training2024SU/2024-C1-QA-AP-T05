...
/*
    ...
    public static @NotNull String getBody(String pais, String service) {
        String cuerpo = String.format(readFile("src/test/resources/archivosxml/"+service),pais);
        //String cuerpo = String.format(readFile("src/test/resources/archivosxml/" + service ), pais);
        return cuerpo;
    }
